...
public class BloomEffect : MonoBehaviour {
	...
	public RenderTexture origionRT;
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination) {
        ...
        if (origionRT != null)
        {
			//origionRT.width = source.width;
			//origionRT.height = source.height;
			//origionRT.format = source.format;
			Graphics.Blit(source, origionRT);
		}
        ...
        if (resultRT!=null)
        {
			Graphics.Blit(currentSource, resultRT, bloom, ApplyBloomPass);
		}
		RenderTexture.ReleaseTemporary(currentSource);
	}
}